...
public class TeXTextContentImpl extends ASTWrapperPsiElement implements TeXTextContent {

  public TeXTextContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeXVisitor visitor) {
    visitor.visitTextContent(this);
  }
