...
public class TeXTextContextImpl extends ASTWrapperPsiElement implements TeXTextContext {

  public TeXTextContextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeXVisitor visitor) {
    visitor.visitTextContext(this);
  }
