...
public class TeXDisplayMathContextImpl extends ASTWrapperPsiElement implements TeXDisplayMathContext {

  public TeXDisplayMathContextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TeXVisitor visitor) {
    visitor.visitDisplayMathContext(this);
  }
